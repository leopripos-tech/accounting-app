...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Perubahan Modal</div>
        </div>
    </div>
            ...
            <div class="card-body">
                <form method="GET" autocomplete="false" class="row mb-4" style="width: 100%">
                    ...
                    <div class="col text-right">
                        <a href="<?= site_url("report/capital/pdf") ?>" class="btn btn-info">Download Pdf</a>
                        <a href="<?= site_url("report/capital/excel") ?>" class="btn btn-info">Download Excel</a>
                    </div>
                </form>
                    ...
                    <tbody>
                        <?php foreach ($items as $index => $item) : ?>
                            <tr>
                                ...
                                <td class="text-right">
                                    <?= number_format($item->capital_debit ?? 0) ?>
                                </td>
                                <td class="text-right">
                                    <?= number_format($item->capital_credit ?? 0) ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
